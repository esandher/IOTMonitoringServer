...
const char ssid[] = "COLEGIO"; // TODO cambiar por el nombre de la red WiFi
// Contraseña de la red WiFi
const char pass[] = "a1b1c1d1e1"; // TODO cambiar por la contraseña de la red WiFi
...
const char MQTT_HOST[] = "44.202.111.23"; // TODO Reemplace ip.maquina.mqtt por la IP del bróker MQTT que usted desplegó. Ej: 192.168.0.1
